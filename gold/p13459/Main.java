...
public class Main {
	...
	static boolean calc(int[] list, int idx, Pair R, Pair B) {
		...
		return calc(list, idx + 1, R, B);
	}

	static boolean perm(int[] list, int idx) {
		if (idx == 10) {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println(perm(new int[10], 0) ? 1 : 0);
	}
}